      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
          <Select value={activeTab} onValueChange={setActiveTab}>
            ...
            <SelectContent>
              <SelectItem value="store">Informações da Loja</SelectItem>
          ...
          <Button 
            ...
            className="w-full md:w-auto gap-2 bg-rose-600 hover:bg-rose-700" 
            disabled={isLoading}
          >
      ...
      <div className="space-y-4">
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader className="space-y-1">
                <CardTitle className="text-xl md:text-2xl">Informações da Loja</CardTitle>
                <CardDescription>
        ...
        {activeTab === "notifications" && (
          <div className="space-y-4">
            <Card>
              <CardHeader className="space-y-1">
                <CardTitle className="text-xl md:text-2xl">Configurações de Notificações</CardTitle>
                <CardDescription>
            ...
            <Card>
              <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between space-y-2 md:space-y-0">
                <div className="space-y-1">
                  <CardTitle className="text-xl md:text-2xl">Usuários do Sistema</CardTitle>
                  <CardDescription>Gerencie os usuários que têm acesso ao painel administrativo.</CardDescription>
                </div>
                <Button className="w-full md:w-auto bg-rose-600 hover:bg-rose-700">
              ...
              <CardContent>
                <div className="space-y-4">
                  {users.map((user) => (
                    <div key={user.id} className="flex flex-col md:flex-row items-start md:items-center justify-between p-4 border rounded-md gap-4">
                      <div className="flex items-start md:items-center gap-4 w-full md:w-auto">
                        ...
                        <div className="min-w-0 flex-1"> {/* Added min-w-0 and flex-1 */}
                          <p className="font-medium truncate">{user.name}</p> {/* Added truncate */}
                      ...
                      <div className="flex gap-2 w-full md:w-auto shrink-0"> {/* Added shrink-0 */}
